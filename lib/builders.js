...
export const nodeFlags = freeze({ token: false, escape: false, trivia: false });
...
export const syntacticFlags = freeze({ token: true, escape: false, trivia: false });
...
export const escapeFlags = freeze({ token: false, escape: true, trivia: false });
...
export const syntacticEscapeFlags = freeze({ token: true, escape: true, trivia: false });
...
export const syntacticTriviaFlags = freeze({ token: true, escape: false, trivia: true });
...
export const triviaFlags = freeze({ token: false, escape: false, trivia: true });
